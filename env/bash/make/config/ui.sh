...
# ============================================================
# CONFIG: ui
# DESCRIPTION: ui and content
# ============================================================

# just some affirmation to make your day better ;=)
# check this source: https://github.com/annthurium/affirmations/
export PROJECT_WISHES=(
  "You got this"
...
# special Friday-only wishes
export FRIDAY_WISHES=(
  "It's Friday! Push to production and walk away slowly. 💣"
  "Happy Friday! May your weekend be bug-free."
  "Friday mode engaged: Code quality 100%, Stress 0%."
  "Deploying on a Friday? You're a brave soul. Good luck!"
  "The weekend is near. Finish strong!"
)